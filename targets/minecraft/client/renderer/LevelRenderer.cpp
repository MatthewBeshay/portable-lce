...
// Legacy per-face cloud CBuffs are retired — renderAdvancedClouds
// builds transient MeshBuilders per frame. The id allocation is
// kept here only because the bgfx backend still references cloudList
// indirectly through the CBuff opcode path.
